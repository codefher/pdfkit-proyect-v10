  ...
  const table = {
    ...
    datas: [
      ...
      },
      {
        ...
        price4: '4.111111',
        price2: '$2',
        price3: { label: 'PRICE $3', options: { fontSize: 12, backgroundColor: 'red', backgroundOpacity: 0.5 } }
      },
      {
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean mattis ante in laoreet egestas. ',
        price1: '$1',
      ...
      },
      {
        ...
        price4: '4',
        name: 'Name 1',
        options: { backgroundColor: 'green', backgroundOpacity: 0.5, separation: true }
      },
      {
        name: 'Name 3',
        description: 'Lorem ipsum dolor.',
        ...
        price4: '4.111111',
        price2: '$2',
        price3: { label: 'PRICE $3', options: { fontSize: 12, separation: true, backgroundColor: 'red', backgroundOpacity: 0.5 } }
      },
      {
        name: 'Name 3',
        description: 'Lorem ipsum dolor.',
